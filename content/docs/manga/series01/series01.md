---
title: "왜 현대인은 다시 만화를 읽어야 하는가? 팝콘 브레인 시대, 시각적 문해력을 회복하는 가장 좋은 방법"
date: 2026-06-01
lastmod: 2026-07-01
bookHidden: true
...
# 왜 현대인은 다시 만화를 읽어야 하는가? 팝콘 브레인 시대, 시각적 문해력을 회복하는 가장 좋은 방법

이 글은 **「왜 지금 시대에 만화를 읽어야 하는가」 3부작의 1부**이다. 짧은 영상과 끊임없는 정보 소비가 일상이 된 환경에서, 인간의 사고 방식과 읽기 능력은 빠르게 변화하고 있다. 이 글은 그 변화 속에서 **시각적 문해력과 깊은 읽기 능력**이 왜 중요해졌는지, 그리고 만화가 어떤 역할을 할 수 있는지 설명한다.

2부에서는 **최고의 미니멀리즘 취미라는 점**을, 3부에서는 **디지털 환경에서의 만화 감상 방식**까지 확장해 다룬다.
...
### Q1. 만화를 읽는 것이 문해력 향상에 실제로 도움이 되는가
