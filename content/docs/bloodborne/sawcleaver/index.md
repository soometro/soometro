---
title: "블러드본의 톱단창 vs 톱창 끝없는 논란 종결합니다."
date: 2026-06-17
lastmod: 2026-06-28
bookHidden: true
weight: 1
description: "그냥 근력캐는 톱단창을, 기술캐는 톱창을...근기 캐릭은 근력보정을 통한 톱단창을 사용하는게 낫다고 봅니다. 굳이 톱단창과, 톱창 뭐가 좋아요?  라는 질문에 본글은 결론은 톱단창이 더 좋다입니다.  톱창 빠들이 보기엔...   어그로 끄는 글일것듯 해서 사실 그리 편하진 않습니다."
---

# 블러드본의 톱단창 vs 톱창 끝없는 논란 종결합니다.

![금단의숲 이벤트 무서운야수](images/sawcreaver.jpg)

그냥 근력캐는 톱단창을, 기술캐는 톱창을...근기 캐릭은 근력보정을 통한 톱단창을 사용하는게 낫다고 봅니다. 굳이 톱단창과, 톱창 뭐가 좋아요?  라는 질문에 본글은 결론은 톱단창이 더 좋다입니다. 
...
27.2보다 같거나 조금더 아주 조금 27.2를 겨우 넘어서는데요.  

레벨이 올라가면 갈수록 근력심연이 더 강해지므로, 본인의 혈정석이 상대적으로 파팅 난이도가 낮은 27.2가 갖추어 졌다면, 그 후 야피주 파밍을 해서 **근력 심연** 으로 세팅하시기 바랍니다.   
...
근력과 기술을 동일하게 찍은 경우 공격력 측면에서는 톱창을 사용할 이유가 없습니다. (사실 저 정도 공격력 차이라면 취향차이라는...)

* **어찌보면 근력심연 세팅이 궁극의 세팅**일 것입니다. 광녀, 유령 제외하고요!
...
보통 톱단창이나 톱창으로 연타 시, R1 - L1 - L1 - L1 - L1 으로 공격을 하게 됩니다.
...
2. 야수 추가 데미지는 변형 후 톱창은 붙지만, 변형후 톱단창은 붙지 않습니다.(날이 안쪽에 없습니다.) 그래서 변형 후는 톱창이 더 셉니다.  

하지만, R1 후 L1 변형 연타시에는 톱날이 있는 부분으로 때리기 때문에 톱단창 톱창 모두 야수 추가 데미지가 붙습니다.

그리고 변형후만 가지고 싸우는 경우는 PVP에 간혹쓰이고.
필드전, 혹은 보스전에서 사용하는 유저는 본적도 없고, 필자도 사용하지 않습니다.
톱단창 변형 후는 아미그달라 머리를 칠때 간혹 사용합니다.  
**톱창의 변형 후 야수추뎀이 별 쓸데가 없다는 말입니다.**
