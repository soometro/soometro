...
위 표의 야수 피의 주인(야피주) 혈정석 옵션은 1옵션 물리 24.8% 상승에 2옵션 HP 최대 시 공격력 5.7% 상승으로 계산을 한값이 **540.1** 이다. 
...
표에 기록된 공격력 5.7% 상승된 **540.1**보다 수치상으로는 적은 513.4가 나오지만, 데미지 +30을 붙이는 것은 조건 없이 확정적으로 적용되기 때문에 실전에서는 가산 옵션이 더 좋다고 말할 수 있다.  
